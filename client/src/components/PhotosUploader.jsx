  ...
  return (
    <>
      ...
      <div className="mt-2 gap-2 grid  grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="h-32 flex cursor-pointer justify-center items-center gap-1 border border-gray-200 bg-transparent rounded-2xl p-2 text-2xl text-gray-600">
